...
cat js3.js source/http.js source/html-scripts.js > js3.dom.js
cat js3.js source/node.xhr.js source/http.js source/node.exports.js > js3.node.js
mv js3.dom.js js3.js
